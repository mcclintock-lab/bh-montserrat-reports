...
OverviewTab = (function(_super) {
  ...
  OverviewTab.prototype.dependencies = ['SizeAndConnectivity', 'DiveAndFishingValue', 'Distance', 'MinDimensionToolbox', 'SATestToolbox'];
  ...
  OverviewTab.prototype.render = function() {
    ...
    try {
      ...
      console.log("Spatial Analyst Test: ", satest.data.value);
    } catch (_error) {
      e = _error;
      console.log("Spatial Analyst failed", e);
    }
    if (dfv) {
      if (dfv.PERCENT < 0.01) {
