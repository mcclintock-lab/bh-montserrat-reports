...
TradeoffsTab = (function(_super) {
  ...
  TradeoffsTab.prototype.render = function() {
    ...
    if (window.d3) {
      return this.setupScatterPlot(tradeoff_data, '.fishing-v-diving', "Value of Fishing", "Value of Diving", "Fishing", "Diving");
    }
  };
