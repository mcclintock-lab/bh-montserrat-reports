...
EnvironmentTab = (function(_super) {
  ...
  EnvironmentTab.prototype.render = function() {
    var all_fish_vals, all_herb_vals, all_sandg_vals, all_total_values, context, coral_count, d3IsPresent, fish, fish_bio, habitats, hasConservationZone, herb, herb_bio, isCollection, sandg, total, total_bio, _ref1;
    ...
    if (isCollection) {
      ...
      hasConservationZone = this.getHasConservationZone([this.model]);
    }
    ...
    for (_i = 0, _len = sketches.length; _i < _len; _i++) {
      ...
      for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
        ...
        if (attr.exportid === "ZONE_TYPE") {
          hasConservationZone = attr.value === "Sanctuary" || attr.value === "Marine Reserve - Partial Take";
        }
      }
    }
