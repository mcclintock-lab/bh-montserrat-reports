    ...
    for (_i = 0, _len = sketches.length; _i < _len; _i++) {
      ...
      for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
        ...
        if (attr.exportid === "ZONE_TYPE") {
          hasZoneWithGoal = attr.value !== "Mooring Anchorage Zone" && attr.value !== "Recreation Zone";
        }
      }
    }
